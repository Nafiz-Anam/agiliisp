...
export default function LoginPage() {
    ...
    const onSubmit = async (data: LoginForm) => {
        ...
        try {
            ...
            router.push(
                loggedUser?.role === "CUSTOMER" ? "/portal" : "/dashboard",
            );
        } catch (err: any) {
        ...
        <div className="min-h-screen flex">
            ...
            <div className="hidden lg:flex lg:w-1/2 bg-linear-to-br from-slate-900 via-slate-800 to-slate-900 relative overflow-hidden">
                <div
                    ...
                    style={{
                        backgroundImage:
                            "url(\"data:image/svg+xml,%3Csvg width='60' height='60' viewBox='0 0 60 60' xmlns='http://www.w3.org/2000/svg'%3E%3Cg fill='%23fff' fill-opacity='0.4'%3E%3Cpath d='M36 34v2h-2v-2h2zm0-4h2v2h-2v-2zm-4 8v-2h2v2h-2zm2-2v-2h2v2h-2z'/%3E%3C/g%3E%3C/svg%3E\")",
                    }}
                />
                <div className="relative z-10 flex flex-col justify-center px-16 text-white">
                    ...
                    <p className="text-lg text-slate-400 max-w-md leading-relaxed">
                        Manage your entire ISP business — customers, routers,
                        billing, support tickets, and resellers from one
                        powerful platform.
                    </p>
                ...
                <div className="w-full max-w-[400px]">
                    ...
                    >
                        <div className="space-y-2">
                            <Label
                                htmlFor="email"
                                className="text-slate-600 text-[13px] font-medium"
                            >
                                Email address
                            </Label>
                            <Input
